...
- the signature of the message must be valid under the sender's pseudonymous credential
- the signature on the pseudonymous credential must be valid under the sender's client credential
...
This is because clients are not expected to change their client credential and use the same client credential to sign pseudonymous credentials in all of their groups.
